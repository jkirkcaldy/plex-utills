...
#### TZ
Your local timezone. Should be in the format `Europe/London` or `America/New_York` 
See here for more information: [TZdata Wikipedia](https://en.wikipedia.org/wiki/List_of_tz_database_time_zones) 
...
To install on Unraid, you need to have the Community Apps plugin. If you don't have it [click here to install](https://unraid.net/community/apps)
...
![unraid-settings](https://github.com/jkirkcaldy/plex-utills/blob/177982ee9a6b17e800f634a6c4dd1376df088f38/app/img/Examples/Unraid-CA-Plex-utills.png?raw=true)
...
Once docker is installed, open the docker settings window on your synology server. Then click on Registry and search for Plex-utills
![](https://i.imgur.com/KTjNIlw.png)
Click on the result jkirkcaldy/plex-utills and click download. 

For the image tag, select latest.
![](https://i.imgur.com/fG19eYC.png)
...
![](https://i.imgur.com/W3azpBv.png)

In that window, click on Volume. We need to add three volumes for the container to work. Click on add volume and add the three volumes. These are:
/config
/logs
/films
...
![](https://i.imgur.com/orNGVzc.png)

Change this to your timezone.  [Click here to find what that should be](https://en.wikipedia.org/wiki/List_of_tz_database_time_zones)
...
![](https://i.imgur.com/zifVr8r.png)

Once you have located the port number your container is running on, open a new browser window and enter <your-server-ip>:<port>
In my case the server is running on IP address 10.254.100.81 and the container is using port 49158 (my ports changed when taking the images)

So I entrer http://10.254.100.81:49158 into my browser window and I get the plex-utills webui

![](https://i.imgur.com/EqjROo0.png)
